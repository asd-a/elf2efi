...
Portions Copyright (c) 2016 - 2020, Hewlett Packard Enterprise Development LP. All rights
reserved.<BR> Portions Copyright (c) 2022, Loongson Technology Corporation Limited. All rights
reserved.<BR>
...
#define EFI_IMAGE_FILE_EXECUTABLE_IMAGE                                                        \
    BIT1 ///< 0x0002  File is executable  (i.e. no unresolved externel references).
...
#define EFI_IMAGE_SCN_LNK_INFO                                                                 \
    BIT9 ///< 0x00000200  ///< Section contains comments or some other type of information.
...
#define EFI_IMAGE_REL_I386_SEG12                                                               \
    0x0009 ///< Direct 16-bit reference to the segment-selector bits of a 32-bit virtual
           ///< address.
